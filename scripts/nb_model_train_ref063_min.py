...
for idx, csft in enumerate(ref_063_min_day_lut_ds_x.cspp_sft.data.tolist()):
    ...
    cloudy_da_fea_total.to_hdf5('%s_60.h5' % ref_063_min_day.short_name, '/%s/cloudy' % csft)

    clear_da_fea_total.to_hdf5('%s_60.h5' % ref_063_min_day.short_name, '/%s/clear' % csft)
