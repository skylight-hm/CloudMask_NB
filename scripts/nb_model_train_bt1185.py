...
from metesatpy.algorithms.CloudMask import Bt1185
...
for idx, csft in enumerate(bt1185_lut_ds_x.cspp_sft.data.tolist()):
    ...
    cloudy_da_fea_total.to_hdf5('%s_60.h5' % bt1185.short_name, '/%s/cloudy' % csft)

    clear_da_fea_total.to_hdf5('%s_60.h5' % bt1185.short_name, '/%s/clear' % csft)
...
bt1185_lut_ds_x.to_netcdf(r'D:\WorkSpace\20200429\project\data\LUT\Btd_11_85_60.nc')
